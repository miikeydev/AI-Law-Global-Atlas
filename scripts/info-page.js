...
const INFO_COPY = {
  fr: {
    ...
    projectParagraph1: 'Ce projet a été réalisé par une étudiante en double diplôme de droit international à l\'Université Paris-Panthéon-Assas, avec l\'aide d\'un étudiant ingénieur en IA à l\'université Paris Saclay, dans l\'optique d\'offrir une approche comparative des différents encadrements juridiques de l\'intelligence artificielle à travers le monde. Ce travail reste néanmoins celui d\'une étudiante. Il a été mené avec le plus grand souci de rigueur et autant d\'encadrement que possible, mais il a vocation à constituer avant tout un point de départ pour vos propres recherches, et non une source exhaustive ou définitive.',
  ...
  en: {
    ...
    projectParagraph1: 'This project was developed by a student pursuing a dual degree in International Law at Paris-Panthéon-Assas University, with the help of an AI engineering student at Paris Saclay University, with the objective of providing a comparative analysis of the various legal frameworks governing artificial intelligence worldwide. Nevertheless, this work remains that of a student. While conducted with the utmost commitment to rigor and under as much academic guidance as possible, it is intended primarily as a starting point for your own research, rather than an exhaustive or definitive authority.',
