...
function updateFooterCopy() {
  ...
  if (footer && footerCopy) {
    ...
    const legal = footer.querySelector('[data-i18n="footer.legal"]');
    if (legal && footerCopy.legal) {
      legal.textContent = footerCopy.legal;
    }
  }
  initContactModal();
...
function initContactModal() {
  ...
  const t = {
    ...
    roleE: lang === 'en' ? 'Concept · Research & Writing · UI Design' : 'Concept · Recherche & Rédaction · UI Design',
